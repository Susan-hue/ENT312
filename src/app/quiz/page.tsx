  ...
  return (
    <PageShell bottomPad="quiz" className="py-4 sm:py-6">
      ...
      <article className="mt-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:mt-6 sm:p-5">
        ...
        {isAnswered && (
          <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm sm:p-4">
            ...
            <div className="mt-3">
              <button
                ...
                className="inline-flex items-center rounded-full border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-100"
              >
